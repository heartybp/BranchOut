      ...
      <div className="flex-1 p-4 bg-slate-50">
        ...
        <div className="grid grid-cols-5 gap-6">
          ...
          <div className="bg-white rounded-lg shadow p-4 col-span-2">
            ...
            <div className="mb-4">
              <button className="w-full border rounded-lg py-2 px-4 flex items-center justify-center space-x-2 bg-gray-50">
            ...
            {/* Current Mentor - Now using MentorImage */}
            ...
            <div className="grid grid-cols-4 gap-4">
              {suggestedConnections.map((connection) => (
                <div key={connection.id} className="border rounded-lg p-3 bg-gray-50">
                  <div className="flex flex-col items-center mb-3">
                    <div className="w-16 h-16 rounded-full overflow-hidden mb-2">
                      <img src={MentorImage} alt="Connection" className="w-full h-full object-cover" />
                    </div>
                    <div className="text-center">
