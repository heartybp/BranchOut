          ...
          <div className="col-span-2 pl-4 flex-col">
            <div className="flex space-x-4 mb-4">
              <button
                ...
                className={`px-4 py-2 rounded ${activeTab === 'students' ? 'border-green-900 text-green-900 text-xl' : 'border-slate-400 '}`}
              >
                Students
              </button>
              <button
                onClick={() => setActiveTab('mentors')}
                className={`px-4 py-2 rounded ${activeTab === 'mentors' ? 'border-green-900 text-green-900 text-xl' : 'border-slate-400'}`}
              >
                Mentors
              </button>
            </div>
