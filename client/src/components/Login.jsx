...
import {MailOutlined, DiscordOutlined, GoogleOutlined, UserOutlined, LockOutlined, CheckOutlined, QuestionCircleFilled} from '@ant-design/icons';
    ...
    return (
        <div className="flex h-screen text-[#F5F5DC]">
            {auth && (
                <div className='fixed flex w-full h-screen z-[99] bg-black bg-opacity-50 items-center justify-center'>
                    <div className='relative flex flex-col w-1/3 h-1/4 rounded-xl bg-white text-black'>
                        <div className='absolute w-full p-4 font-bold text-right' onClick={handleClick} >X</div>
                        <div className='flex flex-col w-full h-full items-center justify-center'>
                            <div className='text-2xl px-2 font-bold text-center'>A 2FA code has been sent to your email!</div>
            ...
            {forgotPassword && (
                <div className='fixed flex w-full h-screen z-[99] bg-black bg-opacity-50 items-center justify-center'>
                    <div className='relative flex flex-col w-1/3 h-1/4 rounded-xl bg-white text-black'>
                        <div className='absolute w-full p-4 font-bold text-right' onClick={handleClick2}>X</div>
                        <div className='flex flex-col w-full h-full items-center justify-center'> 
                            <div className='text-2xl font-bold px-2 text-center'>We sent an email to help you recover your password!</div>    
                        </div>
            ...
            <div className="w-2/5 bg-white h-screen">
                <div className="h-full">
                    <div className="flex h-full pt-20 flex-col w-full ">
                        ...
                        <form action="" className="flex h-4/5 pt-10 w-full flex-col items-center  text-black">
                            <div className=' flex flex-col w-4/5 h-full items-center justify-center text-left'>
                                ...
                                <div className="w-full">
                                    ...
                                    />
                                    <p className="cursor-pointer text-right" onClick={handleClick2}>Forgot your password?</p>
                                </div>
