...
const WorkItem = ({title, job_type, company, startDate, endDate, location, description})=> (
	...
	return (
		<div className="absolute top-10 h-full w-full bg-gradient-to-b from-gray-900 to-gray-800">
			...
			<div className="relative top-10 left-64 h-full w-3/5 bg-white rounded-xl border border-solid border-gray-500">
				{/* ----- INFORMATION BODY ----- */}
				<ul className="absolute top-8 left-10 w-3/12">
					{/* ----- CONTACT INFO ----- */}
					<li className=" bg-gray-100 rounded-lg mb-5" >
						...
						<div alt="Birthday" className="p-2"> 
							<img src="https://icons.veryicon.com/png/o/commerce-shopping/b-end-shopping-guide-application/birthday-10.png" 
								className="relative -top-1 w-4 h-4 inline opacity-50"/> 
				...
				<ul className='absolute top-8 right-10 w-7/12'>
					...
					<li className='bg-gray-100 rounded-lg mb-5'>
						<span className="text-2xl font-semibold p-2">Work Experience</span>
						<div className="p-2"> 
						</div>
					</li>
				</ul>
